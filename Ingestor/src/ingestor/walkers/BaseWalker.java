...
public abstract class BaseWalker {
	protected abstract void initialize(String inSourcePath);
	protected abstract void run() throws InterruptedException, IOException, Exception;
	protected abstract void waitForThreads();
}
